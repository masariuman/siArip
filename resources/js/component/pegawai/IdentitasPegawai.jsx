                                    ...
                                    <div className="element-box">
                                            <div className="masariuman_marginBottom50px">
                                                ...
                                                <div className="float-right">
                                                    <Link to={`/identitasPegawai/${this.state.url}/edit`} className="mr-2 mb-2 btn btn-warning" id="ubah">
                                            ...
                                            <div className="form-desc text-center">
                                                <Link to={`/identitasPegawai/${this.state.url}/detail/edit`} className="mr-2 mb-2 btn btn-warning" id="ubah">
                                                    Ubah Identitas Pegawai
                                                </Link>
                                            </div>
                                        </div>
...
export default IdentitasPegawai;
