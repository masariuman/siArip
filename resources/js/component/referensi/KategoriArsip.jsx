...
class KategoriArsip extends Component {
    ...
    handleChangeCari(e) {
        ...
        axios
            .post(`/admin/referensi/kategoriArsip/search`, {
                cari: e.target.value
            })
            .then(response => {
    ...
    handleDeleteButton(e) {
        axios
            .get(`/admin/referensi/kategoriArsip/${e}`)
            .then(response => {
                swal({
                    title: `Yakin ingin menghapus Kategori Arsip ${response.data.data.name}`,
                  ...
                  .then((willDelete) => {
                    if (willDelete) {
                        ...
                        axios
                            .delete(`/admin/referensi/kategoriArsip/${e}`, {
                                url: this.state.url
                            })
                            .then(response => {
                                this.setState({
    ...
    handleSubmit(e) {
        ...
        axios
            .post("/admin/referensi/kategoriArsip", {
    ...
    handleEditSubmit(e) {
        ...
        axios
            .put(`/admin/referensi/kategoriArsip/${this.state.url}`, {
    ...
    getData() {
        ...
        axios
            .get("/admin/referensi/kategoriArsip/deeta")
            .then(response => {
    ...
    handlePageChange(pageNumber) {
        ...
        axios
            .get('/admin/referensi/kategoriArsip/deeta?page='+pageNumber)
            .then(response => {
                this.setState({
                    data: response.data.data.data,
                    loading: false,
                ...
                <div className="modal-dialog modal-lg modal-centered" role="document">
                    ...
                    <div className="onboarding-side-by-side">
                        ...
                        <h4 className="onboarding-title">
                            Tambah Kategori Arsip Baru
                        </h4>
                        <div className="onboarding-text">
                            Masukkan nama Kategori Arsip baru.
                        </div>
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className="col-sm-12">
                                <div className="form-group">
                                    <input
                                        ...
                                        title="Nama Kategori Arsip"
                                        placeholder="Masukkan Nama Kategori Arsip Baru.."
                                        type="text"
                            ...
                            <div className="col-sm-12">
                                <div className="form-group text-center">
                                    <button className="mr-2 mb-2 btn btn-primary" data-target="#onboardingWideFormModal" data-toggle="modal" type="submit">Tambah Kategori Arsip Baru</button>
                                </div>
                            </div>
                            </div>
                        </form>
                ...
                <div className="modal-dialog modal-lg modal-centered" role="document">
                    ...
                    <div className="onboarding-side-by-side">
                        ...
                        <form onSubmit={this.handleEditSubmit}>
                            ...
                            <div className="col-sm-12">
                                <div className="form-group text-center">
                                    <button className="mr-2 mb-2 btn btn-warning" data-target="#onboardingWideFormModal" data-toggle="modal" type="submit">Ubah Nama Kategori Arsip</button>
                                </div>
                            </div>
                            </div>
                        </form>
        ...
        return (
            ...
            <div className="content-w">
                ...
                <div className="top-bar color-scheme-transparent masariuman-height103px">
                    <div className="top-menu-controls masariuman-marginleft30px">
                        ...
                        <div className="masariuman-textleft">
                            <span className="masariuman-bold">Kategori Arsip</span> <br/>
                            <small>Manajemen Kategori Arsip</small>
                        </div>
                    </div>
                ...
                <ul className="breadcrumb">
                    ...
                    <li className="breadcrumb-item">
                        <span>Manajemen Kategori Arsip</span>
                    </li>
                </ul>
                            ...
                            <div className="element-wrapper">
                                ...
                                <div className="element-box">
                                    ...
                                    <div className="form-desc">
                                        Manajemen Data Kategori Arsip
                                    </div>
                                    <div>
                                        <button className="mr-2 mb-2 btn btn-primary" data-target="#tambahModal" data-toggle="modal" type="button" id="buttonTambahModal">Tambah Kategori Arsip Baru</button>
                                        <div className="col-sm-4 float-right" id="cari">
                                            <input type="text" className="form-control" onChange={this.handleChangeCari}
                                                value={this.state.cari} placeholder="Cari Kategori Arsip..."></input>
                                        </div>
                                    </div>
                                    <div className="table-responsive" id="kategoriArsipTable">
