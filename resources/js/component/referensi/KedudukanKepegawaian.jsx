...
class KedudukanKepegawaian extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    handleChangeCari(e) {
        ...
        axios
            .post(`/admin/referensi/kedudukanKepegawaian/search`, {
                cari: e.target.value
            })
            .then(response => {
    ...
    handleDeleteButton(e) {
        axios
            .get(`/admin/referensi/kedudukanKepegawaian/${e}`)
            .then(response => {
                swal({
                    title: `Yakin ingin menghapus Kedudukan Kepegawaian ${response.data.data.name}`,
                  ...
                  .then((willDelete) => {
                    if (willDelete) {
                        ...
                        axios
                            .delete(`/admin/referensi/kedudukanKepegawaian/${e}`, {
                                url: this.state.url
                            })
                            .then(response => {
                                this.setState({
    ...
    handleSubmit(e) {
        ...
        axios
            .post("/admin/referensi/kedudukanKepegawaian", {
    ...
    handleEditSubmit(e) {
        ...
        axios
            .put(`/admin/referensi/kedudukanKepegawaian/${this.state.url}`, {
    ...
    getData() {
        ...
        axios
            .get("/admin/referensi/kedudukanKepegawaian/deeta")
            .then(response => {
    ...
    handlePageChange(pageNumber) {
        ...
        axios
            .get('/admin/referensi/kedudukanKepegawaian/deeta?page='+pageNumber)
            .then(response => {
                this.setState({
                    data: response.data.data.data,
                    loading: false,
                ...
                <div className="modal-dialog modal-lg modal-centered" role="document">
                    ...
                    <div className="onboarding-side-by-side">
                        ...
                        <h4 className="onboarding-title">
                            Tambah Kedudukan Kepegawaian Baru
                        </h4>
                        <div className="onboarding-text">
                            Masukkan nama Kedudukan Kepegawaian baru.
                        </div>
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className="col-sm-12">
                                <div className="form-group text-center">
                                    <button className="mr-2 mb-2 btn btn-primary" data-target="#onboardingWideFormModal" data-toggle="modal" type="submit">Tambah Kedudukan Kepegawaian Baru</button>
                                </div>
                            </div>
                            </div>
                        </form>
            ...
            <div aria-hidden="true" className="onboarding-modal modal fade animated" id="editModal" role="dialog" tabIndex="-1">
                <div className="modal-dialog modal-lg modal-centered" role="document">
                    ...
                    <div className="onboarding-side-by-side">
                        ...
                        <div className="onboarding-content with-gradient masariuman_width100percent">
                        <h4 className="onboarding-title">
                            Ubah Nama Kedudukan Kepegawaian
                        </h4>
                        <div className="onboarding-text">
                            Masukkan nama Kedudukan Kepegawaian baru.
                        </div>
                        <form onSubmit={this.handleEditSubmit}>
                            ...
                            <div className="col-sm-12">
                                <div className="form-group text-center">
                                    <button className="mr-2 mb-2 btn btn-warning" data-target="#onboardingWideFormModal" data-toggle="modal" type="submit">Ubah Nama Kedudukan Kepegawaian</button>
                                </div>
                            </div>
                            </div>
                        </form>
            ...
            <div className="content-w">
                ...
                <div className="top-bar color-scheme-transparent masariuman-height103px">
                    <div className="top-menu-controls masariuman-marginleft30px">
                        ...
                        <div className="masariuman-textleft">
                            <span className="masariuman-bold">Kedudukan Kepegawaian</span> <br/>
                            <small>Manajemen Kedudukan Kepegawaian</small>
                        </div>
                    </div>
                ...
                <ul className="breadcrumb">
                    <li className="breadcrumb-item">
                        <a>Kedudukan Kepegawaian</a>
                    </li>
                    <li className="breadcrumb-item">
                        <span>Manajemen Kedudukan Kepegawaian</span>
                    </li>
                </ul>
                        ...
                        <div className="content-box">
                            <div className="element-wrapper">
                                ...
                                <div className="element-box">
                                    ...
                                    Daftar Kedudukan Kepegawaian
                                    </h5>
                                    <div className="form-desc">
                                        Manajemen Data Kedudukan Kepegawaian
                                    </div>
                                    <div>
                                        <button className="mr-2 mb-2 btn btn-primary" data-target="#tambahModal" data-toggle="modal" type="button" id="buttonTambahModal">Tambah Kedudukan Kepegawaian Baru</button>
                                        <div className="col-sm-4 float-right" id="cari">
                                            <input type="text" className="form-control" onChange={this.handleChangeCari}
                                                value={this.state.cari} placeholder="Cari Kedudukan Kepegawaian..."></input>
                                        </div>
                                    </div>
                                    <div className="table-responsive" id="kedudukanKepegawaianTable">
                                        <table id="tabeldata" width="100%" className="table table-striped table-lightfont">
                                            <thead>
                                                <tr>
                                                    <th className="width50px">NO</th>
                                                    <th>NAMA Kedudukan Kepegawaian</th>
...
export default KedudukanKepegawaian;
