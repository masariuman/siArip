...
class STLUD extends Component {
    ...
    handleChangeCari(e) {
        ...
        axios
            .post(`/admin/referensi/stlud/search`, {
                cari: e.target.value
            })
            .then(response => {
                ...
                swal({
                  ...
                  .then((willDelete) => {
                    if (willDelete) {
                        ...
                        axios
                            .delete(`/admin/referensi/stlud/${e}`, {
                                url: this.state.url
                            })
                            .then(response => {
                                this.setState({
    ...
    handleEditSubmit(e) {
        ...
        axios
            .put(`/admin/referensi/stlud/${this.state.url}`, {
    ...
    getData() {
        ...
        axios
            .get("/admin/referensi/stlud/deeta")
            .then(response => {
    ...
    handlePageChange(pageNumber) {
        ...
        axios
            .get('/admin/referensi/stlud/deeta?page='+pageNumber)
            .then(response => {
                this.setState({
                    data: response.data.data.data,
                    loading: false,
