...
class PejabatPenetap extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    handleChangeCari(e) {
        ...
        axios
            .post(`/admin/referensi/pejabatPenetap/search`, {
                cari: e.target.value
            })
            .then(response => {
    ...
    handleDeleteButton(e) {
        axios
            .get(`/admin/referensi/pejabatPenetap/${e}`)
            .then(response => {
                swal({
                    title: `Yakin ingin menghapus Pejabat Penetap ${response.data.data.name}`,
                  ...
                  .then((willDelete) => {
                    if (willDelete) {
                        ...
                        axios
                            .delete(`/admin/referensi/pejabatPenetap/${e}`, {
                                url: this.state.url
                            })
                            .then(response => {
                                this.setState({
    ...
    handleSubmit(e) {
        ...
        axios
            .post("/admin/referensi/pejabatPenetap", {
    ...
    handleEditSubmit(e) {
        ...
        axios
            .put(`/admin/referensi/pejabatPenetap/${this.state.url}`, {
    ...
    getData() {
        ...
        axios
            .get("/admin/referensi/pejabatPenetap/deeta")
            .then(response => {
    ...
    handlePageChange(pageNumber) {
        ...
        axios
            .get('/admin/referensi/pejabatPenetap/deeta?page='+pageNumber)
            .then(response => {
                this.setState({
                    data: response.data.data.data,
                    loading: false,
                ...
                <div className="modal-dialog modal-lg modal-centered" role="document">
                    ...
                    <div className="onboarding-side-by-side">
                        ...
                        <h4 className="onboarding-title">
                            Tambah Pejabat Penetap Baru
                        </h4>
                        <div className="onboarding-text">
                            Masukkan nama Pejabat Penetap baru.
                        </div>
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className="col-sm-12">
                                <div className="form-group">
                                    <input
                                        ...
                                        title="Nama Pejabat Penetap"
                                        placeholder="Masukkan Nama Pejabat Penetap Baru.."
                                        type="text"
                            ...
                            <div className="col-sm-12">
                                <div className="form-group text-center">
                                    <button className="mr-2 mb-2 btn btn-primary" data-target="#onboardingWideFormModal" data-toggle="modal" type="submit">Tambah Pejabat Penetap Baru</button>
                                </div>
                            </div>
                            </div>
                        </form>
                ...
                <div className="modal-dialog modal-lg modal-centered" role="document">
                    ...
                    <div className="onboarding-side-by-side">
                        ...
                        <form onSubmit={this.handleEditSubmit}>
                            ...
                            <div className="col-sm-12">
                                <div className="form-group text-center">
                                    <button className="mr-2 mb-2 btn btn-warning" data-target="#onboardingWideFormModal" data-toggle="modal" type="submit">Ubah Nama Pejabat Penetap</button>
                                </div>
                            </div>
                            </div>
                        </form>
        ...
        return (
            ...
            <div className="content-w">
                ...
                <div className="top-bar color-scheme-transparent masariuman-height103px">
                    <div className="top-menu-controls masariuman-marginleft30px">
                        ...
                        <div className="masariuman-textleft">
                            <span className="masariuman-bold">Pejabat Penetap</span> <br/>
                            <small>Manajemen Pejabat Penetap</small>
                        </div>
                    </div>
                ...
                <ul className="breadcrumb">
                    ...
                    <li className="breadcrumb-item">
                        <span>Manajemen Pejabat Penetap</span>
                    </li>
                </ul>
                        ...
                        <div className="content-box">
                            <div className="element-wrapper">
                                ...
                                <div className="element-box">
                                    ...
                                    Daftar Pejabat Penetap
                                    </h5>
                                    <div className="form-desc">
                                        Manajemen Data Pejabat Penetap
                                    </div>
                                    <div>
                                        <button className="mr-2 mb-2 btn btn-primary" data-target="#tambahModal" data-toggle="modal" type="button" id="buttonTambahModal">Tambah Pejabat Penetap Baru</button>
                                        <div className="col-sm-4 float-right" id="cari">
                                            <input type="text" className="form-control" onChange={this.handleChangeCari}
                                                value={this.state.cari} placeholder="Cari Pejabat Penetap..."></input>
                                        </div>
                                    </div>
                                    <div className="table-responsive" id="pejabatPenetapTable">
                                        <table id="tabeldata" width="100%" className="table table-striped table-lightfont">
                                            <thead>
                                                <tr>
                                                    <th className="width50px">NO</th>
                                                    <th>NAMA Pejabat Penetap</th>
