...
class JabatanFungsionalUmum extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    handleChangeCari(e) {
        ...
        axios
            .post(`/admin/referensi/jabatanFungsionalUmum/search`, {
                cari: e.target.value
            })
            .then(response => {
    ...
    handleDeleteButton(e) {
        axios
            .get(`/admin/referensi/jabatanFungsionalUmum/${e}`)
            .then(response => {
                swal({
                    title: `Yakin ingin menghapus Jabatan Fungsional Umum ${response.data.data.name}`,
                  ...
                  .then((willDelete) => {
                    if (willDelete) {
                        ...
                        axios
                            .delete(`/admin/referensi/jabatanFungsionalUmum/${e}`, {
                                url: this.state.url
                            })
                            .then(response => {
                                this.setState({
    ...
    handleSubmit(e) {
        ...
        axios
            .post("/admin/referensi/jabatanFungsionalUmum", {
    ...
    handleEditSubmit(e) {
        ...
        axios
            .put(`/admin/referensi/jabatanFungsionalUmum/${this.state.url}`, {
    ...
    getData() {
        ...
        axios
            .get("/admin/referensi/jabatanFungsionalUmum/deeta")
            .then(response => {
    ...
    handlePageChange(pageNumber) {
        ...
        axios
            .get('/admin/referensi/jabatanFungsionalUmum/deeta?page='+pageNumber)
            .then(response => {
                this.setState({
                    data: response.data.data.data,
                    loading: false,
                ...
                <div className="modal-dialog modal-lg modal-centered" role="document">
                    ...
                    <div className="onboarding-side-by-side">
                        ...
                        <h4 className="onboarding-title">
                            Tambah Jabatan Fungsional Umum Baru
                        </h4>
                        <div className="onboarding-text">
                            Masukkan nama Jabatan Fungsional Umum baru.
                        </div>
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className="col-sm-12">
                                <div className="form-group">
                                    <input
                                        ...
                                        title="Nama Jabatan Fungsional Umum"
                                        placeholder="Masukkan Nama Jabatan Fungsional Umum Baru.."
                                        type="text"
                            ...
                            <div className="col-sm-12">
                                <div className="form-group text-center">
                                    <button className="mr-2 mb-2 btn btn-primary" data-target="#onboardingWideFormModal" data-toggle="modal" type="submit">Tambah Jabatan Fungsional Umum Baru</button>
                                </div>
                            </div>
                            </div>
                        </form>
            ...
            <div aria-hidden="true" className="onboarding-modal modal fade animated" id="editModal" role="dialog" tabIndex="-1">
                <div className="modal-dialog modal-lg modal-centered" role="document">
                    ...
                    <div className="onboarding-side-by-side">
                        ...
                        <div className="onboarding-content with-gradient masariuman_width100percent">
                        <h4 className="onboarding-title">
                            Ubah Nama Jabatan Fungsional Umum
                        </h4>
                        <div className="onboarding-text">
                            Masukkan nama Jabatan Fungsional Umum baru.
                        </div>
                        <form onSubmit={this.handleEditSubmit}>
                            ...
                            <div className="col-sm-12">
                                <div className="form-group text-center">
                                    <button className="mr-2 mb-2 btn btn-warning" data-target="#onboardingWideFormModal" data-toggle="modal" type="submit">Ubah Nama Jabatan Fungsional Umum</button>
                                </div>
                            </div>
                            </div>
                        </form>
            ...
            <div className="content-w">
                ...
                <div className="top-bar color-scheme-transparent masariuman-height103px">
                    <div className="top-menu-controls masariuman-marginleft30px">
                        ...
                        <div className="masariuman-textleft">
                            <span className="masariuman-bold">Jabatan Fungsional Umum</span> <br/>
                            <small>Manajemen Jabatan Fungsional Umum</small>
                        </div>
                    </div>
                ...
                <ul className="breadcrumb">
                    <li className="breadcrumb-item">
                        <a>Jabatan Fungsional Umum</a>
                    </li>
                    <li className="breadcrumb-item">
                        <span>Manajemen Jabatan Fungsional Umum</span>
                    </li>
                </ul>
                            ...
                            <div className="element-wrapper">
                                ...
                                <div className="element-box">
                                    ...
                                    <div className="form-desc">
                                        Manajemen Data Jabatan Fungsional Umum
                                    </div>
                                    <div>
                                        <button className="mr-2 mb-2 btn btn-primary" data-target="#tambahModal" data-toggle="modal" type="button" id="buttonTambahModal">Tambah Jabatan Fungsional Umum Baru</button>
                                        <div className="col-sm-4 float-right" id="cari">
                                            <input type="text" className="form-control" onChange={this.handleChangeCari}
                                                value={this.state.cari} placeholder="Cari Jabatan Fungsional Umum..."></input>
                                        </div>
                                    </div>
                                    <div className="table-responsive" id="jabatanFungsionalUmumTable">
                                        <table id="tabeldata" width="100%" className="table table-striped table-lightfont">
                                            <thead>
                                                <tr>
                                                    <th className="width50px">NO</th>
                                                    <th>NAMA Jabatan Fungsional Umum</th>
...
export default JabatanFungsionalUmum;
