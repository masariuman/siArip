...
class JenisNaikPangkat extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    handleChangeCari(e) {
        ...
        axios
            .post(`/admin/referensi/jenisNaikPangkat/search`, {
                cari: e.target.value
            })
            .then(response => {
    ...
    handleDeleteButton(e) {
        axios
            .get(`/admin/referensi/jenisNaikPangkat/${e}`)
            .then(response => {
                swal({
                    title: `Yakin ingin menghapus Jenis Naik Pangkat ${response.data.data.name}`,
                  ...
                  .then((willDelete) => {
                    if (willDelete) {
                        ...
                        axios
                            .delete(`/admin/referensi/jenisNaikPangkat/${e}`, {
                                url: this.state.url
                            })
                            .then(response => {
                                this.setState({
    ...
    handleSubmit(e) {
        ...
        axios
            .post("/admin/referensi/jenisNaikPangkat", {
    ...
    handleEditSubmit(e) {
        ...
        axios
            .put(`/admin/referensi/jenisNaikPangkat/${this.state.url}`, {
    ...
    getData() {
        ...
        axios
            .get("/admin/referensi/jenisNaikPangkat/deeta")
            .then(response => {
    ...
    handlePageChange(pageNumber) {
        ...
        axios
            .get('/admin/referensi/jenisNaikPangkat/deeta?page='+pageNumber)
            .then(response => {
                this.setState({
                    data: response.data.data.data,
                    loading: false,
                ...
                <div className="modal-dialog modal-lg modal-centered" role="document">
                    ...
                    <div className="onboarding-side-by-side">
                        ...
                        <h4 className="onboarding-title">
                            Tambah Jenis Naik Pangkat Baru
                        </h4>
                        <div className="onboarding-text">
                            Masukkan nama Jenis Naik Pangkat baru.
                        </div>
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className="col-sm-12">
                                <div className="form-group">
                                    <input
                                        ...
                                        title="Nama Jenis Naik Pangkat"
                                        placeholder="Masukkan Nama Jenis Naik Pangkat Baru.."
                                        type="text"
                            ...
                            <div className="col-sm-12">
                                <div className="form-group text-center">
                                    <button className="mr-2 mb-2 btn btn-primary" data-target="#onboardingWideFormModal" data-toggle="modal" type="submit">Tambah Jenis Naik Pangkat Baru</button>
                                </div>
                            </div>
                            </div>
                        </form>
                ...
                <div className="modal-dialog modal-lg modal-centered" role="document">
                    ...
                    <div className="onboarding-side-by-side">
                        ...
                        <form onSubmit={this.handleEditSubmit}>
                            ...
                            <div className="col-sm-12">
                                <div className="form-group text-center">
                                    <button className="mr-2 mb-2 btn btn-warning" data-target="#onboardingWideFormModal" data-toggle="modal" type="submit">Ubah Nama Jenis Naik Pangkat</button>
                                </div>
                            </div>
                            </div>
                        </form>
            ...
            <div className="content-w">
                ...
                <div className="top-bar color-scheme-transparent masariuman-height103px">
                    <div className="top-menu-controls masariuman-marginleft30px">
                        ...
                        <div className="masariuman-textleft">
                            <span className="masariuman-bold">Jenis Naik Pangkat</span> <br/>
                            <small>Manajemen Jenis Naik Pangkat</small>
                        </div>
                    </div>
                ...
                <ul className="breadcrumb">
                    <li className="breadcrumb-item">
                        <a>Jenis Naik Pangkat</a>
                    </li>
                    <li className="breadcrumb-item">
                        <span>Manajemen Jenis Naik Pangkat</span>
                    </li>
                </ul>
                        ...
                        <div className="content-box">
                            <div className="element-wrapper">
                                ...
                                <div className="element-box">
                                    ...
                                    Daftar Jenis Naik Pangkat
                                    </h5>
                                    <div className="form-desc">
                                        Manajemen Data Jenis Naik Pangkat
                                    </div>
                                    <div>
                                        <button className="mr-2 mb-2 btn btn-primary" data-target="#tambahModal" data-toggle="modal" type="button" id="buttonTambahModal">Tambah Jenis Naik Pangkat Baru</button>
                                        <div className="col-sm-4 float-right" id="cari">
                                            <input type="text" className="form-control" onChange={this.handleChangeCari}
                                                value={this.state.cari} placeholder="Cari Jenis Naik Pangkat..."></input>
                                        </div>
                                    </div>
                                    <div className="table-responsive" id="jenisNaikPangkatTable">
                                        <table id="tabeldata" width="100%" className="table table-striped table-lightfont">
                                            <thead>
                                                <tr>
                                                    <th className="width50px">NO</th>
                                                    <th>NAMA Jenis Naik Pangkat</th>
...
export default JenisNaikPangkat;
